...
async function deriveKeyAndIvByPbkdf2(salt: Uint8Array, password: string, options: { keyBits: 128 | 192 | 256, iterations: number, hash: "SHA-256" }): Promise<{ key: Uint8Array, iv: Uint8Array }> {
...
export function aesCtrEncryptWithPbkdf2(readableStream: ReadableStream<Uint8Array>, password: string, pbkdf2Options: { keyBits: 128 | 192 | 256, iterations: number, hash: "SHA-256" } ): ReadableStream<Uint8Array> {
...
export function aesCtrDecryptWithPbkdf2(encryptedReadableStream: ReadableStream<Uint8Array>, password: string, pbkdf2Options: { keyBits: 128 | 192 | 256, iterations: number, hash: "SHA-256" } ): ReadableStream<Uint8Array> {
